...
export default function ComprasView({ tenantSlug }: Props) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-gray-900">Compras Avançado</h1>
        <p className="text-sm text-gray-400 mt-0.5">Fluxo completo: Requisição → MRP → Lista → Cotação → Pedido → Conferência</p>
      </div>
