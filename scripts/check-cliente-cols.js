...
pool.connect().then(async client => {
  ...
  const r = await client.query(`SELECT column_name FROM information_schema.columns WHERE table_name='t_cliente' ORDER BY ordinal_position`)
  console.log('Colunas t_cliente:', r.rows.map(r => r.column_name))
