/**
 * Escreve lib/services/cadastros/ComposicaoService.ts com o conteúdo correto.
 * Use quando o arquivo estiver vazio/corrompido por falha de cópia.
 * Rodar: node scripts/write-composicao-service.js
 */
const fs   = require('fs')
const path = require('path')

const destino = path.join('lib', 'services', 'cadastros', 'ComposicaoService.ts')
...
console.log(`OK: ${destino} escrito com ${tamanho} bytes`)
console.log(tamanho > 2000 ? '✓ Conteudo gravado corretamente' : '✗ ATENCAO: arquivo pequeno demais')