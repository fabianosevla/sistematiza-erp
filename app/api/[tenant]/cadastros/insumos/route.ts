...
// Tipo padrão do insumo quando a tela não informa.
// Precisa casar com um valor de Cadastros → Domínios (tipo_insumo), senão o
// registro nasce com um tipo que não existe na lista e vira o problema que
// scripts/normalizar-dominios.js teve que consertar.
const TIPO_PADRAO = 'Matéria Prima'
  ...
  try {
    ...
    try {
      ...
      `, [
        ...
        // A coluna é NOT NULL: passar null aqui quebrava o insert quando a
        // tela não mandava o tipo. Agora cai no padrão, que é um valor válido
        // de domínio.
        body.tipo?.trim() || TIPO_PADRAO,
