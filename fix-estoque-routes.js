...
fs.writeFileSync('app/api/[tenant]/estoque/insumos/route.ts', rotaInsumos, 'utf8')
console.log('OK: estoque/insumos reescrita com pool+search_path+busca')

fs.writeFileSync('app/api/[tenant]/estoque/produtos/route.ts', rotaProdutos, 'utf8')
console.log('OK: estoque/produtos reescrita com pool+search_path+busca')